        ...
        <div class="duongdan">
            <div class="container">
                ...
                <ol typeof="BreadcrumbList" class="breadcrumb breadcrumb__t">
                    ...
                    <li property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage"
                            href="{{route('home')}}"><span property="name">Bài viết - Tin tức</span></a>
                ...
                <div class="search-form search-form__h">
                    <div class="content_search">
                        <form id="search-header" class="navbar-form" method="get" action="{{ route('searchPost') }}"
                            ...
                            <input type="text" name="key" placeholder="Tìm kiếm bài viết..." class="input_search">
                        ...
                        <div class="wow fadeInUp col-xs-6 col-sm-4 post_item" data-wow-delay="0.1s">
                            <div class="content_item">
                                ...
                                <div class="post_meta">
                                    ...
                                    <div class="readmore">
                                        <a href="{{ route('posts.show', $post->slug) }}"
                                            title="{{$post->title}}">Xem chi tiết<i class="far fa-chevron-right"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>

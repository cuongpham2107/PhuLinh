...
<div class="layout-contact">
    <div class="container">
        <div class="row">
            <div class="col-xl-1 col-lg-1 col-md-1 col-sm-0 col-xs-0">
            </div>
            <div class="col-xl-10 col-lg-10 col-md-12 col-sm-12 col-xs-12 bg-white bg-pading">
                <div class="div-pos-pa">
                </div>
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12">
                        <div class="title-contact">
                            <h3>Thông tin liên hệ</h3>
                            <p>Bạn hãy điền nội dung tin nhắn vào form dưới đây và gửi cho chúng tôi. Chúng tôi
                                sẽ trả lời bạn sau khi nhận được.</p>
                        </div>
                        <div class="section right_contact">
                            <div id="pagelogin">
                                <form method="post"  action="{{route('contacts')}}" id="contact" accept-charset="UTF-8">  
                                 @csrf                         
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12">
                        <div class="div-info-contact">
                            ...
                            <div class="contact-box">
                                <div class="icon">
                                    <svg height="512pt" viewBox="0 0 512.00069 512" width="512pt"
                            ...
                            <div class="contact-box">
                                ...
                                <div class="content">
                                    <a class="fone" href="tel:{{setting('site.phone')}}" title="{{setting('site.phone')}}">0{{ preg_replace('~.*(\d{3})[^\d]{0,7}(\d{3})[^\d]{0,7}(\d{4}).*~', '$1 $2 $3', setting('site.phone')) }}</a>
                                </div>
                            </div>
                            ...
                            <div class="contact-box">
                                ...
                                <div class="content">
                                    <a href="mailto:{{setting('site.email')}}" title="{{setting('site.email')}}">{{setting('site.email')}}</a>
                                </div>
                            </div>
                            <div class="contact-box">
                                <div class="icon">
